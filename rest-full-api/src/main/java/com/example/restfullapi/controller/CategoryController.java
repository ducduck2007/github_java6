...
import com.example.restfullapi.model.request.CategoryRequest;
import com.example.restfullapi.model.response.CategoryResponse;
import com.example.restfullapi.service.CategoryService;
...
public class CategoryController {
    ...
    public void addCate(@RequestBody CategoryRequest request) {
        System.out.println("Received: " + request.getCategoryCode() + " - " + request.getCategoryName());
